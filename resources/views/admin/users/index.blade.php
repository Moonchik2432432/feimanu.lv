                        ...
                        <div style="display:flex; flex-direction:column; gap:8px;">
                            ...
                            @else
                                ...
                                >
                                    ...
                                    <input type="text" class="datetime-picker" name="blocked_until" placeholder= "Ja bloķēšanas laiks netiek izvēlēts, lietotājs automātiski tiek bloķēts uz 1 mēnesi." style="padding:6px;">

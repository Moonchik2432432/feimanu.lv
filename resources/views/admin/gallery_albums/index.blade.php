...
<div class="container" style="max-width:1100px; margin:40px auto;">
    ...
    <div style="display:flex; justify-content:space-between; gap:15px; flex-wrap:wrap; align-items:end; margin:15px 0;">
        ...
        <form method="GET" action="{{ route('admin.gallery.albums') }}" style="display:flex; gap:10px; flex-wrap:wrap; align-items:end;">

            <div>
                <label>Nosaukums</label><br>
                <input type="text" name="q" value="{{ $q ?? '' }}" placeholder="Nosaukums" style="padding:8px; width:220px;">
            </div>

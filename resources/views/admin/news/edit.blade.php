...
<div class="container" style="max-width:850px; margin:40px auto;">
    ...
    <form method="POST" action="{{ route('admin.news.update', $post->ieraksts_id) }}" enctype="multipart/form-data">
        ...
        <div style="margin:10px 0;">
            ...
            <textarea name="saturs" rows="6" style="width:100%; padding:8px; box-sizing:border-box;">{{ old('saturs', $post->saturs) }}</textarea>
        </div>
        ...
        <div style="margin:20px 0;">
            ...
            <div style="margin-bottom:15px;">
                ...
                @else
                    <div style="color:gray; margin-bottom:10px;">Nav bildes</div>
                @endif
            </div>
            ...
            ">
                ...
                <div style="margin-top:12px; color:#666;">
                    Tiks izmantota jauna bilde no tava datora.
                </div>
            </div>

...
">
    ...
    <div>
        <img id="avatar-preview"
             src="{{ asset($user->avatar ? 'img/usersAvatars/' . $user->avatar : 'img/usersAvatars/default_avatar.jpg') }}"
...
document.getElementById('avatar-input').addEventListener('change', function(event) {
    ...
    if (file) {
        document.getElementById('avatar-name').innerText = file.name;

        if (!file.type.startsWith('image/')) {
            alert('Lūdzu, izvēlies attēlu!');
            return;
        }
